...
export default [
  {
    ...
    // is not reformatted on the way in. Linting it would mean either editing generated
    // output by hand or carrying rule disables that the next regeneration drops. It is
    // still type-checked: `tsc --noEmit` reads it, which is the whole reason it exists.
    ignores: [
      'dist/**',
      '**/.astro/**',
      'node_modules/**',
