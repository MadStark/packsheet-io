 ...
 *     states that collapse into one wrong message without it. This query used to carry
 *     `.is('deleted_at', null)` as well, which mattered for that reading specifically: a
 *     closet whose every item sat in the trash had to report as EMPTY rather than as
